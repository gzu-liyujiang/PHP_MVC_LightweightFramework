...
class AnnounceController extends ApiController
{
    ...
    public function get()
    {
        ...
        if ($mouth==9 && $day>24 && $day<28) {
            $title = '祝中秋快乐';
            $icon = 'http://ime.qqtheme.cn/data/announce/zhongqiu.gif';
            $expire = 3*24;
        } else if ($mouth==10 && $day>1 && $day<9) {
            $title = '祝国庆快乐';
            $icon = 'http://ime.qqtheme.cn/data/announce/guoqing.gif';
            $expire = 7*24;
        } else if ($mouth==10 && $day==21) {
            $title = '祝重阳快乐';
            $icon = 'http://ime.qqtheme.cn/data/announce/chongyang.gif';
            $expire = 24;
        } else if ($mouth==11 && $day==11) {
            $title = '祝单身快乐';
            $icon = 'http://ime.qqtheme.cn/data/announce/guanggun.gif';
            $expire = 24;
        } else if ($mouth==11 && $day==26) {
            $title = '拥有感恩的心';
            $icon = 'http://ime.qqtheme.cn/data/announce/ganen.gif';
            $expire = 24;
        } else if ($mouth==12 && $day>23 && $day<25) {
            $title = '祝圣诞快乐';
            $icon = 'http://ime.qqtheme.cn/data/announce/shengdan.gif';
            $expire = 2*24;
        } else {
            $icon = '';
            //$icon = 'http://ime.qqtheme.cn/data/announce/click.gif';
            $expire = 10*24;
        }
        $data = array(
            'type' => $type,
